...
const TaskForm: React.FC = () => {
  ...
  // Efecto tilt y gradiente radial
  useEffect(() => {
  ...
  return (
    <>
      <style>{`
        /* El mismo CSS exacto de Login.tsx */
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .gt{font-family:'Bebas Neue',sans-serif;font-size:3.2rem;letter-spacing:.04em;color:#fff;position:relative;display:inline-block;line-height:1;}
          ...
          >
            ...
            <div className="la">
              ...
              <div
                ...
                data-text="NUEVA TAREA"
              >
                NUEVA TAREA
              </div>
              <span className="ls">Completa los datos</span>
            </div>
            <form onSubmit={handleSubmit}>
                    ...
                    <div className="fib">
                      ...
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          d="M4 7h16M4 12h16M4 17h16M7 3v4M17 3v4"
                        />
              ...
              <div className="action-buttons">
                ...
                >
                  ...
                  <div className="sbg" />
                  <div className="sbs" />
                  <span className="sbt">Cancelar</span>
                </button>
                <button type="submit" disabled={isLoading} className="sb">
                  <div className="sbb" />
                  <div className="sbg" />
                  <div className="sbs" />
                  <span className="sbt">
